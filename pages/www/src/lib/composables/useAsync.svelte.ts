...
import type { LoadingState, AppError } from '$lib/types';
import { toAppError, logError } from '$lib/utils/error-handling';
...
export function usePagination<T>(
  fetchFunction: (page: number, limit: number) => Promise<{ items: T[]; total: number; hasMore: boolean }>,
  options: {
    initialPage?: number;
    pageSize?: number;
    immediate?: boolean;
