...
import type { LottoNumber, RoundNumber, LoadingState, ValidationResult } from './index.js';
...
/** Input variants */
export type InputVariant = 'default' | 'bordered' | 'ghost' | 'primary' | 'secondary' | 'accent' | 'error' | 'warning' | 'success';
...
export interface InputProps extends 
  Omit<HTMLInputAttributes, 'class' | 'size'>, 
  BaseComponentProps {
...
/** Card variants */
export type CardVariant = 'default' | 'bordered' | 'compact' | 'side' | 'image-full';
...
/** Form field props */
export interface FormFieldProps extends BaseComponentProps, ComponentWithChildren {
  label?: string;
  required?: boolean;
  helperText?: string;
  errorText?: string;
...
/** Tooltip props */
export interface TooltipProps extends BaseComponentProps, ComponentWithChildren {
...
export interface BadgeProps extends BaseComponentProps, ComponentWithChildren {
  variant?: 'default' | 'primary' | 'secondary' | 'accent' | 'ghost' | 'outline' | 'success' | 'warning' | 'error' | 'info';
  size?: 'xs' | 'sm' | 'md' | 'lg';
}
...
export interface ContainerProps extends BaseComponentProps, ComponentWithChildren {
