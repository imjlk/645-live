...
class TrailBaseClient {
  ...
  private connectionStateSubscribers = new Map<string, ConnectionStateCallback>();
...
export const subscribeToScanCountUpdates = (id: string, callback: SubscriberCallback) => 
  trailbaseClient.subscribe(id, callback);

export const subscribeToConnectionState = (id: string, callback: ConnectionStateCallback) => 
...
export const getLatestScanData = () => 
  trailbaseClient.getLatestScanData();

export const reconnectClient = () => 
  trailbaseClient.reconnect();