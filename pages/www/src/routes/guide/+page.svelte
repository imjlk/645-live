...
const guideSection = [
	{
		...
		items: [
			{
				title: "로또란 무엇인가요?",
				content: "로또 6/45는 1부터 45까지의 숫자 중 6개를 선택하여 추첨번호와 일치하는 개수에 따라 당첨되는 복권입니다. 매주 토요일 오후 8시 45분에 추첨이 진행됩니다."
			},
			{
				title: "게임 방법",
				content: "1장당 1,000원으로 구매할 수 있으며, A부터 E까지 5게임을 한 장에서 플레이할 수 있습니다. 수동 선택 또는 자동 선택(컴퓨터가 무작위 선택) 중 선택 가능합니다."
			},
			{
				title: "당첨 기준",
				content: "1등: 6개 모두 일치, 2등: 5개 일치 + 보너스번호, 3등: 5개 일치, 4등: 4개 일치, 5등: 3개 일치로 구성됩니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "당첨 확률",
				content: "1등 당첨 확률은 약 814만 분의 1입니다. 2등은 약 135만 분의 1, 3등은 약 3만 5천 분의 1, 4등은 약 733분의 1, 5등은 약 45분의 1입니다."
			},
			{
				title: "예상 상금",
				content: "1등 상금은 누적 방식으로 평균 20억원 내외이며, 당첨자 수에 따라 분배됩니다. 2등~5등은 고정 상금으로 운영됩니다."
			},
			{
				title: "세금 안내",
				content: "당첨금이 5만원을 초과하면 22%의 세금이 자동으로 원천징수됩니다. 3억원 이상 고액 당첨 시 추가 세금 신고가 필요합니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "구매 장소",
				content: "전국 로또 판매점, 편의점, 온라인(동행복권 사이트), 모바일 앱에서 구매 가능합니다. 판매 마감은 추첨일 오후 8시까지입니다."
			},
			{
				title: "번호 선택 전략",
				content: "통계적으로는 모든 번호가 동일한 확률을 가지지만, 과거 당첨번호 분석, 홀짝 균형, 연속번호 회피 등의 전략을 활용할 수 있습니다."
			},
			{
				title: "현명한 구매 팁",
				content: "여유 자금으로만 구매하고, 과도한 구매는 피해야 합니다. 꾸준한 소액 구매가 무리한 고액 구매보다 현명합니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "당첨 확인",
				content: "추첨 후 동행복권 홈페이지, 모바일 앱, 로또 판매점에서 당첨번호를 확인할 수 있습니다. QR코드를 통한 확인도 가능합니다."
			},
			{
				title: "당첨금 수령",
				content: "5만원 이하: 판매점에서 즉시 수령, 5만원 초과: 은행 또는 농협중앙회에서 수령, 1억원 이상: 농협중앙회 본점 또는 지역본부에서만 수령 가능합니다."
			},
			{
				title: "수령 기한",
				content: "당첨금 수령 기한은 지급 개시일로부터 1년입니다. 기한 내 미수령 시 당첨금은 복권기금으로 귀속됩니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "보너스 번호",
				content: "기본 6개 번호 외에 추가로 추첨되는 1개 번호로, 2등 당첨 시에만 사용됩니다."
			},
			{
				title: "수동/자동 선택",
				content: "수동: 직접 번호를 선택하는 방식, 자동: 컴퓨터가 무작위로 번호를 선택하는 방식입니다."
			},
			{
				title: "누적금",
				content: "1등 당첨자가 없을 경우 다음 회차로 이월되는 상금으로, 이월 횟수가 많을수록 1등 상금이 커집니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "출현 빈도 분석",
				content: "각 번호별 과거 출현 횟수를 분석하여 '뜨거운 번호'와 '차가운 번호'를 파악할 수 있습니다. 단, 미래 당첨을 보장하지는 않습니다."
			},
			{
				title: "패턴 분석",
				content: "홀짝 분포, 고저 분포, 연속번호 패턴 등을 분석하여 번호 선택에 참고할 수 있습니다."
			},
			{
				title: "통계의 한계",
				content: "과거 데이터는 참고용일 뿐, 로또는 완전한 확률 게임이므로 통계로 미래를 예측할 수는 없습니다."
			}
		]
	},
	{
		...
		items: [
			{
				title: "적정 구매",
				content: "월 소득의 1-2% 이내에서 여유 자금으로만 구매하고, 생활비나 투자금을 사용하지 않아야 합니다."
			},
			{
				title: "중독 예방",
				content: "복권은 오락의 성격이 강하므로 과도한 기대나 의존을 피하고, 구매 한도를 정해두는 것이 좋습니다."
			},
			{
				title: "도움 받기",
				content: "복권 중독이 의심되면 한국도박문제관리센터(국번없이 1336) 등 전문 기관의 도움을 받을 수 있습니다."
			}
		]
	}
];
