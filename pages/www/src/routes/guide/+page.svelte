...
const faqData = [
	{
		...
		answer: "로또 6/45는 1부터 45까지의 숫자 중 6개를 선택하여 추첨번호와 일치하는 개수에 따라 당첨되는 복권입니다. 매주 토요일 오후 8시 45분에 추첨이 진행되며, 1장당 1,000원으로 구매할 수 있습니다."
	},
	{
		question: "로또 1등 당첨 확률은 얼마나 되나요?",
		answer: "로또 1등 당첨 확률은 약 814만 분의 1입니다. 이는 8,145,060분의 1로, 매우 낮은 확률입니다. 2등은 약 135만 분의 1, 3등은 약 3만 5천 분의 1의 확률을 가집니다."
	},
	{
		question: "로또는 어디서 구매할 수 있나요?",
		answer: "전국 로또 판매점, 편의점, 동행복권 홈페이지, 모바일 앱에서 구매할 수 있습니다. 판매 마감은 추첨일(토요일) 오후 8시까지이며, 미성년자는 구매할 수 없습니다."
	},
	{
		question: "당첨금에는 세금이 얼마나 부과되나요?",
		answer: "당첨금이 5만원을 초과하면 22%의 세금이 자동으로 원천징수됩니다. 3억원 이상 고액 당첨 시에는 추가적인 세금 신고가 필요할 수 있습니다."
	},
	{
		question: "당첨금은 언제까지 받을 수 있나요?",
		answer: "당첨금 수령 기한은 지급 개시일로부터 1년입니다. 기한 내 미수령 시 당첨금은 복권기금으로 귀속되므로 반드시 기한 내에 수령해야 합니다."
	},
	{
		question: "보너스 번호는 무엇인가요?",
		answer: "보너스 번호는 기본 6개 번호 외에 추가로 추첨되는 1개 번호로, 2등 당첨 시에만 사용됩니다. 5개 번호가 일치하고 보너스 번호까지 일치하면 2등에 당첨됩니다."
	},
	{
		question: "로또 통계는 번호 선택에 도움이 되나요?",
		answer: "과거 데이터 분석은 참고용일 뿐입니다. 로또는 완전한 확률 게임이므로 통계로 미래 당첨번호를 예측할 수는 없습니다. 모든 번호는 동일한 당첨 확률을 가집니다."
	},
	{
		question: "얼마까지 로또를 사는 것이 적정한가요?",
		answer: "월 소득의 1-2% 이내에서 여유 자금으로만 구매하는 것이 권장됩니다. 생활비나 투자금을 사용하지 않고, 과도한 기대나 의존을 피하는 것이 중요합니다."
	},
	{
		question: "QR 코드로 로또를 스캔할 수 있나요?",
		answer: "645.live에서는 로또 용지의 QR 코드를 스캔하는 기능을 제공합니다. 구매한 로또 용지를 스마트폰 카메라로 스캔하면 자동으로 당첨 여부를 확인할 수 있습니다. 별도의 앱 설치 없이 웹브라우저에서 바로 이용할 수 있습니다."
	},
	{
		question: "실시간 스캔 현황은 무엇인가요?",
		answer: "645.live는 전국의 로또 구매자들이 QR 스캔한 데이터를 실시간으로 수집하여, 각 번호별로 얼마나 많이 선택되고 있는지 통계를 제공합니다. 이를 통해 인기 번호와 비인기 번호를 파악할 수 있으며, 다른 사람들이 어떤 번호를 선호하는지 확인할 수 있습니다."
	}
];
