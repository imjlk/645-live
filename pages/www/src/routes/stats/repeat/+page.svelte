...
const generateJsonLd = () => {
	return {
		...
		headline: "로또 6/45 연속 번호 분석 통계",
		description:
			"로또 6/45 연속 회차 간 중복 번호 패턴을 분석합니다. 이전 회차와의 번호 중복 빈도와 연속성 트렌드를 제공합니다.",
		...
		mainEntity: {
			"@type": "Dataset",
			name: "로또 6/45 연속 번호 통계",
			description: "로또 6/45 연속 회차 간 중복 번호 및 연속성 분석 데이터",
		},
	};
};
...
<svelte:head>
	<title>로또 6/45 연속 번호 분석 | 회차간 중복 패턴 통계 | 645.live</title>
	<meta name="description" content="로또 6/45 연속 회차 간 중복 번호 패턴을 분석합니다. 이전 회차와의 번호 중복 빈도와 연속성 트렌드를 제공합니다." />
	<meta name="keywords" content="로또, 연속번호, 중복번호, 로또통계, 번호패턴, 연속성분석, 로또예측" />
	<link rel="canonical" href="https://645.live/stats/repeat" />
	
	<!-- Open Graph -->
	<meta property="og:title" content="로또 6/45 연속 번호 분석 | 645.live" />
	<meta property="og:description" content="로또 6/45 연속 회차 간 중복 번호 패턴을 분석합니다." />
	<meta property="og:url" content="https://645.live/stats/repeat" />
	<meta property="og:type" content="article" />
	
	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="로또 6/45 연속 번호 분석" />
	<meta name="twitter:description" content="로또 6/45 연속 회차 간 중복 번호 패턴을 분석합니다." />
</svelte:head>

<div class="p-6 space-y-6">
	<!-- 페이지 헤더 -->
	<div class="text-center space-y-2">
		<h1 class="text-3xl font-bold text-primary">연속 번호 분석</h1>
