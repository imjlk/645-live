/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 1bd37eb3d92bbec8eb6abb572755e202)
// Runtime types generated with workerd@1.20260312.1 2025-05-30 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DATABASE_URL: string;
		HYPERDRIVE_PROXY: string;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		TRAILBASE_URL: string;
		PUBLIC_TRAILBASE_URL: string;
		TRAILBASE_BASIC_AUTH: string;
		OG_645_LIVE: Fetcher /* og-645-live */;
		AUTH_HASHER: Fetcher /* auth-hasher-645-live */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "SKIP_DEPENDENCY_INSTALL" | "DATABASE_URL" | "HYPERDRIVE_PROXY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "TRAILBASE_URL" | "PUBLIC_TRAILBASE_URL" | "TRAILBASE_BASIC_AUTH">> {}
}
