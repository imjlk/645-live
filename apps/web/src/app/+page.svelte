<script lang="ts">
import LottoBall from "@/features/lotto/components/LottoBall.svelte";
import ValueIncrementEffect from "@/features/lotto/components/ValueIncrementEffect.svelte";
...
import type { BallNumber } from "./+page.server";
