export declare function addCronCallback(
	name: string,
	schedule: string,
	cb: () => void | Promise<void>,
): void;

export declare function addPeriodicCallback(
	milliseconds: number,
	cb: (cancel: () => void) => void,
): () => void;
...
export declare function htmlHandler(
...
export declare function jsonHandler(
...
export declare function stringHandler(
