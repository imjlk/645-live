/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 4bc992ab2354de77f2ab2f0379898c2c)
// Runtime types generated with workerd@1.20260312.1 2026-08-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "IndexNowCoordinator";
	}
	interface Env {
		INDEXNOW_DELIVERY_MODE: "relay";
		INDEXNOW_ENABLED: "true";
		INDEXNOW_ENDPOINT: "https://api.indexnow.org/indexnow";
		SITE_BASE_URL: "https://645.live";
		INDEXNOW_KEY: string;
		INDEXNOW_RUN_TOKEN: string;
		INDEXNOW_COORDINATOR: DurableObjectNamespace<import("./index").IndexNowCoordinator>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INDEXNOW_DELIVERY_MODE" | "INDEXNOW_ENABLED" | "INDEXNOW_ENDPOINT" | "SITE_BASE_URL" | "INDEXNOW_KEY" | "INDEXNOW_RUN_TOKEN">> {}
}
